...
HPVsim was first released in mid-2022 as a fully-documented open-source Python [package](https://github.com/starsimhub/hpvsim), and model development continued until version 2.3, which was released in April 2026. In mid-2026, version 3.0 of HPVsim will be released, built on the [Starsim](https://starsim.org/) modeling architecture. The original version of HPVsim will be frozen after version 2.3, aside from any critical bugfixes.
